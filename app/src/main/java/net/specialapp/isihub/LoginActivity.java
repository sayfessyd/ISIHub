...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "foo@example.com:hello", "bar@example.com:world", "mail.sayf@yahoo.com:admin"
    };
    /**
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
                ...
                //String token = btoa(mEmail,mPassword);
                String token = "ZGVtbzpkZW1v";
                SharedPreferences sharedPref = getSharedPreferences("ISIHubPerf",Context.MODE_PRIVATE);
                ...
                try{
                    ...
                    Request request = new Request.Builder()
                            .url("http://52.17.63.166:8080/engine-rest/process-definition")
                            .get()
    ...
    /*public String btoa(String username, String password) {
